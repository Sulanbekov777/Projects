  ...
  return (
    <div>
      <section className="text-center my-5">
        <h2 className="h1-responsive font-weight-bold text-center my-5">BMW</h2>
        ...
        <MDBRow>
          <MDBCol lg="3" md="6" className="mb-lg-0 mb-4">
            <MDBCard className="mt-5" cascade narrow ecommerce>
              <MDBCardImage
                cascade
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTWbLcy9s4ySP6fysFZtr9xD_N7sGdL2OzA-w&usqp=CAU"
                top
                alt="sample photo"
