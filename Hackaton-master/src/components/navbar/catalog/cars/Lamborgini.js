...
function Lamborgini() {
    return (
      ...
      <h2 className='h1-responsive font-weight-bold text-center my-5'>Lamborgini</h2>
      ...
      <MDBRow>
        ...
        <MDBCard className="mt-5"cascade narrow ecommerce>
            <MDBCardImage
              cascade
              src='https://www.topgear.com/sites/default/files/styles/fit_1960x1102/public/news/carousel/2015/04/Large%20Image_8573.jpg?itok=GcOO0bj-'
              top
              alt='sample photo'
        ...
        <MDBCol lg='3' md='6' className='mb-lg-0  mb-4'>
          <MDBCard className="mt-5"cascade narrow ecommerce>
            <MDBCardImage
              cascade
              src='https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSHkaAjwX3sPoSHBD5VaFzCBMihPP0TnigvTw&usqp=CAU'
              top
              alt='sample photo'
              overlay='white-slight'
            />
